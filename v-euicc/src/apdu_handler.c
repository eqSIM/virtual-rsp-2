...
static int process_es10x_command(struct euicc_state *state, uint8_t **response, uint32_t *response_len,
    ...
    case 0xBF20: { // GetEuiccInfo1Request
        ...
        // PKID from generated CI certificate: 4C:2B:D6:1A:42:3D:91:25:04:92:C7:5C:64:22:A1:47:51:DC:94:4A
        uint8_t ci_pk[] = {0x04, 0x14, 0x4C, 0x2B, 0xD6, 0x1A, 0x42, 0x3D, 0x91, 0x25,
                          0x04, 0x92, 0xC7, 0x5C, 0x64, 0x22, 0xA1, 0x47, 0x51, 0xDC, 0x94, 0x4A};
