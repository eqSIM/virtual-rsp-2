...
- **docs/TECHNICAL_FLOW.md** - Complete technical reference
- **docs/AVAILABLE_PROFILES.md** - All profiles explained
- **SGP22_Profile_Download_and_Installation.md** - SGP.22 spec reference
